...
pub struct AcMeterAbn {
    ...
    ///
    /// Phase Voltage BC
    pub ph_vph_bc: Option<i16>,
    /// Phase Voltage CA
    ///
    /// Phase Voltage CA
    pub ph_vph_ca: Option<i16>,
...
impl AcMeterAbn {
    ...
    pub const APH_A: crate::Point<Self, Option<i16>> = crate::Point::new(1, 1, false);
    ...
    pub const PH_VPH_BC: crate::Point<Self, Option<i16>> = crate::Point::new(11, 1, false);
    pub const PH_VPH_CA: crate::Point<Self, Option<i16>> = crate::Point::new(12, 1, false);
...
static AC_METER_ABN_FIELDS: &[crate::FieldInfo] = &[
    crate::FieldInfo {
        name: "a",
        label: "Amps",
...
static AC_METER_ABN_GROUP_INFO: crate::GroupInfo = crate::GroupInfo {
    name: "ac_meter_abn",
    label: "split single phase (ABN) meter",
    description: "",
    fields: AC_METER_ABN_FIELDS,
};
impl crate::GroupMeta for AcMeterAbn {
    fn group_info() -> &'static crate::GroupInfo {
        &AC_METER_ABN_GROUP_INFO
    }
}
impl crate::Group for AcMeterAbn {
    const LEN: u16 = 105;
}
impl AcMeterAbn {
