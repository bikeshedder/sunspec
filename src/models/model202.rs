...
impl Model202 {
    ...
    pub const APHA: crate::PointDef<Self, Option<i16>> = crate::PointDef::new(1, 1, false);
    ...
    pub const PHVPHBC: crate::PointDef<Self, Option<i16>> = crate::PointDef::new(11, 1, false);
    pub const PHVPHCA: crate::PointDef<Self, Option<i16>> = crate::PointDef::new(12, 1, false);
...
impl crate::Model for Model202 {
    ...
    fn from_data(data: &[u16]) -> Result<Self, crate::ReadModelError> {
        Ok(Self {
            ...
            phvphab: Self::PHVPHAB.from_data(data)?,
