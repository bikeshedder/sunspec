//! DER Trip LV
/// Type alias for [`DerTripLv`].
pub type Model707 = DerTripLv;
struct Counts {
    n_pt: u16,
    n_crv_set: u16,
}
...
static DER_TRIP_LV_FIELDS: &[crate::FieldInfo] = &[
    crate::FieldInfo {
        name: "ena",
...
static DER_TRIP_LV_GROUP_INFO: crate::GroupInfo = crate::GroupInfo {
    name: "DERTripLV",
    label: "DER Trip LV",
    description: "DER low voltage trip model.",
    fields: DER_TRIP_LV_FIELDS,
};
impl crate::GroupMeta for DerTripLv {
    fn group_info() -> &'static crate::GroupInfo {
        &DER_TRIP_LV_GROUP_INFO
    }
}
...
impl crate::Model for DerTripLv {
    ...
    const DESCRIPTION: &'static str = "DER low voltage trip model.";
