...
static STRING_COMBINER_CURRENT_INPUT_FIELDS: &[crate::FieldInfo] = &[
    crate::FieldInfo {
        name: "dca_sf",
        label: "DCA_SF",
...
static STRING_COMBINER_CURRENT_INPUT_GROUP_INFO: crate::GroupInfo = crate::GroupInfo {
    name: "string_combiner_current_input",
    label: "String Combiner (Current)",
    description: "A basic string combiner model",
    fields: STRING_COMBINER_CURRENT_INPUT_FIELDS,
};
impl crate::GroupMeta for StringCombinerCurrentInput {
    fn group_info() -> &'static crate::GroupInfo {
        &STRING_COMBINER_CURRENT_INPUT_GROUP_INFO
    }
}
...
impl crate::Model for StringCombinerCurrentInput {
    ...
    const DESCRIPTION: &'static str = "A basic string combiner model";
