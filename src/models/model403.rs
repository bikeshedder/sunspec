...
impl Model403 {
    ...
    pub const INDCA_SF: crate::PointDef<Self, Option<i16>> = crate::PointDef::new(14, 1, false);
    pub const INDCAHR_SF: crate::PointDef<Self, Option<i16>> = crate::PointDef::new(15, 1, false);
}
