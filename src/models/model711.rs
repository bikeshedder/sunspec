...
impl Model711 {
    ...
    pub const RVRTTMS: crate::PointDef<Self, u32> = crate::PointDef::new(4, 2, true);
    pub const RVRTREM: crate::PointDef<Self, u32> = crate::PointDef::new(6, 2, false);
    pub const RVRTCTL: crate::PointDef<Self, u16> = crate::PointDef::new(8, 1, true);
...
impl crate::Model for Model711 {
    ...
    fn from_data(data: &[u16]) -> Result<Self, crate::ReadModelError> {
        Ok(Self {
            ...
            adptctlreq: Self::ADPTCTLREQ
                .from_data(data)?
                .ok_or(crate::ReadPointError::MissingMandatoryValue)?,
            adptctlrslt: Self::ADPTCTLRSLT
                .from_data(data)?
                .ok_or(crate::ReadPointError::MissingMandatoryValue)?,
            nctl: Self::NCTL
                .from_data(data)?
