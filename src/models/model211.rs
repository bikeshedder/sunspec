...
impl Model211 {
    ...
    pub const PPVPHAB: crate::PointDef<Self, Option<f32>> = crate::PointDef::new(18, 2, false);
    pub const PPVPHBC: crate::PointDef<Self, Option<f32>> = crate::PointDef::new(20, 2, false);
    pub const PPVPHCA: crate::PointDef<Self, Option<f32>> = crate::PointDef::new(22, 2, false);
