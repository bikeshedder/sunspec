...
static AC_METER_AN_OR_AB_FLOAT_FIELDS: &[crate::FieldInfo] = &[
    crate::FieldInfo {
        name: "a",
        label: "Amps",
...
static AC_METER_AN_OR_AB_FLOAT_GROUP_INFO: crate::GroupInfo = crate::GroupInfo {
    name: "ac_meter_an_or_ab_float",
    label: "single phase (AN or AB) meter",
    description: "",
    fields: AC_METER_AN_OR_AB_FLOAT_FIELDS,
};
impl crate::GroupMeta for AcMeterAnOrAbFloat {
    fn group_info() -> &'static crate::GroupInfo {
        &AC_METER_AN_OR_AB_FLOAT_GROUP_INFO
    }
}
