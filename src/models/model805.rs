...
impl Model805 {
    ...
    pub const SOC: crate::PointDef<Self, Option<u16>> = crate::PointDef::new(3, 1, false);
    pub const DOD: crate::PointDef<Self, Option<u16>> = crate::PointDef::new(4, 1, false);
    pub const SOH: crate::PointDef<Self, Option<u16>> = crate::PointDef::new(5, 1, false);
    pub const NCYC: crate::PointDef<Self, Option<u32>> = crate::PointDef::new(6, 2, false);
    ...
    pub const CELLVMAXCELL: crate::PointDef<Self, Option<u16>> = crate::PointDef::new(10, 1, false);
    pub const CELLVMIN: crate::PointDef<Self, u16> = crate::PointDef::new(11, 1, false);
    pub const CELLVMINCELL: crate::PointDef<Self, Option<u16>> = crate::PointDef::new(12, 1, false);
    ...
    pub const CELLTMPMAXCELL: crate::PointDef<Self, Option<u16>> =
        crate::PointDef::new(15, 1, false);
    pub const CELLTMPMIN: crate::PointDef<Self, i16> = crate::PointDef::new(16, 1, false);
    pub const CELLTMPMINCELL: crate::PointDef<Self, Option<u16>> =
    ...
    pub const SOC_SF: crate::PointDef<Self, Option<i16>> = crate::PointDef::new(36, 1, false);
...
impl crate::Model for Model805 {
    ...
    fn from_data(data: &[u16]) -> Result<Self, crate::ReadModelError> {
        Ok(Self {
            stridx: Self::STRIDX.from_data(data)?,
            modidx: Self::MODIDX.from_data(data)?,
            ncell: Self::NCELL.from_data(data)?,
            ...
            celltmpmax: Self::CELLTMPMAX.from_data(data)?,
            celltmpmaxcell: Self::CELLTMPMAXCELL.from_data(data)?,
            celltmpmin: Self::CELLTMPMIN.from_data(data)?,
            celltmpmincell: Self::CELLTMPMINCELL.from_data(data)?,
            celltmpavg: Self::CELLTMPAVG.from_data(data)?,
