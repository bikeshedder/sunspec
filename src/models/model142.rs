//! HFRTC
/// Type alias for [`Hfrtc`].
pub type Model142 = Hfrtc;
/// HFRTC
///
...
static HFRTC_FIELDS: &[crate::FieldInfo] = &[
    crate::FieldInfo {
        name: "act_crv",
        label: "ActCrv",
...
static HFRTC_GROUP_INFO: crate::GroupInfo = crate::GroupInfo {
    name: "hfrtc",
    label: "HFRTC",
    description: "HFRT must remain connected",
    fields: HFRTC_FIELDS,
};
impl crate::GroupMeta for Hfrtc {
...
impl crate::Model for Hfrtc {
    ...
    const DESCRIPTION: &'static str = "HFRT must remain connected";
