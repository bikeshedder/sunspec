...
static LVRTC_FIELDS: &[crate::FieldInfo] = &[
    crate::FieldInfo {
        name: "act_crv",
        label: "ActCrv",
...
static LVRTC_GROUP_INFO: crate::GroupInfo = crate::GroupInfo {
    name: "lvrtc",
    label: "LVRTC",
    description: "LVRT must remain connected",
    fields: LVRTC_FIELDS,
};
impl crate::GroupMeta for Lvrtc {
    fn group_info() -> &'static crate::GroupInfo {
        &LVRTC_GROUP_INFO
    }
}
impl crate::Group for Lvrtc {
    const LEN: u16 = 10;
}
impl Lvrtc {
...
static CURVE_FIELDS: &[crate::FieldInfo] = &[
    ...
    crate::FieldInfo {
        name: "v1",
        label: "V1",
        description: "Point 1 must remain connected voltage.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms2",
    ...
    crate::FieldInfo {
        name: "v2",
        label: "V2",
        description: "Point 2 must remain connected voltage.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms3",
    ...
    crate::FieldInfo {
        name: "v3",
        label: "V3",
        description: "Point 3 must remain connected voltage.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms4",
    ...
    crate::FieldInfo {
        name: "v4",
        label: "V4",
        description: "Point 4 must remain connected voltage.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms5",
    ...
    crate::FieldInfo {
        name: "v5",
        label: "V5",
        description: "Point 5 must remain connected voltage.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms6",
    ...
    crate::FieldInfo {
        name: "v6",
        label: "V6",
        description: "Point 6 must remain connected voltage.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms7",
    ...
    crate::FieldInfo {
        name: "v7",
        label: "V7",
        description: "Point 7 must remain connected voltage.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms8",
    ...
    crate::FieldInfo {
        name: "v8",
        label: "V8",
        description: "Point 8 must remain connected voltage.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms9",
    ...
    crate::FieldInfo {
        name: "v9",
        label: "V9",
        description: "Point 9 must remain connected voltage.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms10",
    ...
    crate::FieldInfo {
        name: "v10",
        label: "V10",
        description: "Point 10 must remain connected voltage.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms11",
    ...
    crate::FieldInfo {
        name: "v11",
        label: "V11",
        description: "Point 11 must remain connected voltage.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms12",
    ...
    crate::FieldInfo {
        name: "v12",
        label: "V12",
        description: "Point 12 must remain connected voltage.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms13",
    ...
    crate::FieldInfo {
        name: "v13",
        label: "V13",
        description: "Point 13 must remain connected voltage.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms14",
    ...
    crate::FieldInfo {
        name: "v14",
        label: "V14",
        description: "Point 14 must remain connected voltage.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms15",
    ...
    crate::FieldInfo {
        name: "v15",
        label: "V15",
        description: "Point 15 must remain connected voltage.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms16",
    ...
    crate::FieldInfo {
        name: "v16",
        label: "V16",
        description: "Point 16 must remain connected voltage.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms17",
    ...
    crate::FieldInfo {
        name: "v17",
        label: "V17",
        description: "Point 17 must remain connected voltage.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms18",
    ...
    crate::FieldInfo {
        name: "v18",
        label: "V18",
        description: "Point 18 must remain connected voltage.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms19",
    ...
    crate::FieldInfo {
        name: "v19",
        label: "V19",
        description: "Point 19 must remain connected voltage.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms20",
    ...
    crate::FieldInfo {
        name: "v20",
        label: "V20",
        description: "Point 20 must remain connected voltage.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "crv_nam",
...
impl crate::Model for Lvrtc {
    ...
    const DESCRIPTION: &'static str = "LVRT must remain connected";
