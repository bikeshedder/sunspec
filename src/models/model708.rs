...
static DER_TRIP_HV_FIELDS: &[crate::FieldInfo] = &[
    crate::FieldInfo {
        name: "ena",
        label: "DER Trip HV Module Enable",
        description: "DER high voltage trip control enable.",
...
static DER_TRIP_HV_GROUP_INFO: crate::GroupInfo = crate::GroupInfo {
    name: "DERTripHV",
    label: "DER Trip HV",
    description: "DER high voltage trip model.",
    fields: DER_TRIP_HV_FIELDS,
};
impl crate::GroupMeta for DerTripHv {
    fn group_info() -> &'static crate::GroupInfo {
        &DER_TRIP_HV_GROUP_INFO
    }
}
...
impl crate::Model for DerTripHv {
    ...
    const DESCRIPTION: &'static str = "DER high voltage trip model.";
