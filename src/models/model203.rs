...
static AC_METER_ABCN_FIELDS: &[crate::FieldInfo] = &[
    crate::FieldInfo {
        name: "a",
        label: "Amps",
...
static AC_METER_ABCN_GROUP_INFO: crate::GroupInfo = crate::GroupInfo {
    name: "ac_meter_abcn",
    label: "wye-connect three phase (abcn) meter",
    description: "",
    fields: AC_METER_ABCN_FIELDS,
};
impl crate::GroupMeta for AcMeterAbcn {
    fn group_info() -> &'static crate::GroupInfo {
        &AC_METER_ABCN_GROUP_INFO
    }
}
