...
static LFRT_FIELDS: &[crate::FieldInfo] = &[
    crate::FieldInfo {
        name: "act_crv",
        label: "ActCrv",
...
static LFRT_GROUP_INFO: crate::GroupInfo = crate::GroupInfo {
    name: "lfrt",
    label: "LFRT",
    description: "Low Frequency Ride-through",
    fields: LFRT_FIELDS,
};
impl crate::GroupMeta for Lfrt {
    fn group_info() -> &'static crate::GroupInfo {
        &LFRT_GROUP_INFO
    }
}
impl crate::Group for Lfrt {
    const LEN: u16 = 10;
}
impl Lfrt {
...
impl crate::Model for Lfrt {
    ...
    const DESCRIPTION: &'static str = "Low Frequency Ride-through";
