...
static HFRTX_FIELDS: &[crate::FieldInfo] = &[
    crate::FieldInfo {
        name: "act_crv",
        label: "ActCrv",
...
static HFRTX_GROUP_INFO: crate::GroupInfo = crate::GroupInfo {
    name: "hfrtx",
    label: "HFRTX",
    description: "HFRT extended curve",
    fields: HFRTX_FIELDS,
};
impl crate::GroupMeta for Hfrtx {
...
impl crate::Model for Hfrtx {
    ...
    const DESCRIPTION: &'static str = "HFRT extended curve";
