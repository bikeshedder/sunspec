...
/// Type alias for [`AcMeterAbnFloat`].
...
static AC_METER_ABN_FLOAT_FIELDS: &[crate::FieldInfo] = &[
    crate::FieldInfo {
        name: "a",
        label: "Amps",
...
static AC_METER_ABN_FLOAT_GROUP_INFO: crate::GroupInfo = crate::GroupInfo {
    name: "ac_meter_abn_float",
    label: "split single phase (ABN) meter",
    description: "",
    fields: AC_METER_ABN_FLOAT_FIELDS,
};
impl crate::GroupMeta for AcMeterAbnFloat {
    fn group_info() -> &'static crate::GroupInfo {
        &AC_METER_ABN_FLOAT_GROUP_INFO
    }
}
