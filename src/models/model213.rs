...
/// Type alias for [`AcMeterAbcnFloat`].
pub type Model213 = AcMeterAbcnFloat;
/// wye-connect three phase (abcn) meter
///
/// Detail: Float
#[derive(Debug)]
...
static AC_METER_ABCN_FLOAT_FIELDS: &[crate::FieldInfo] = &[
    crate::FieldInfo {
        name: "a",
        label: "Amps",
...
static AC_METER_ABCN_FLOAT_GROUP_INFO: crate::GroupInfo = crate::GroupInfo {
    name: "ac_meter_abcn_float",
    label: "wye-connect three phase (abcn) meter",
    description: "",
    fields: AC_METER_ABCN_FLOAT_FIELDS,
};
impl crate::GroupMeta for AcMeterAbcnFloat {
    fn group_info() -> &'static crate::GroupInfo {
        &AC_METER_ABCN_FLOAT_GROUP_INFO
    }
}
