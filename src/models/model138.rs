//! HVRTC
/// Type alias for [`Hvrtc`].
pub type Model138 = Hvrtc;
/// HVRTC
///
...
static HVRTC_FIELDS: &[crate::FieldInfo] = &[
    crate::FieldInfo {
        name: "act_crv",
        label: "ActCrv",
...
static HVRTC_GROUP_INFO: crate::GroupInfo = crate::GroupInfo {
    name: "hvrtc",
    label: "HVRTC",
    description: "HVRT must remain connected",
    fields: HVRTC_FIELDS,
};
impl crate::GroupMeta for Hvrtc {
...
impl crate::Model for Hvrtc {
    ...
    const DESCRIPTION: &'static str = "HVRT must remain connected";
