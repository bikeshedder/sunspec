...
impl InverterThreePhaseFloat {
    ...
    pub const PH_VPH_C: crate::Point<Self, f32> = crate::Point::new(18, 2, false);
...
static INVERTER_THREE_PHASE_FLOAT_FIELDS: &[crate::FieldInfo] = &[
    crate::FieldInfo {
        name: "a",
        label: "Amps",
...
static INVERTER_THREE_PHASE_FLOAT_GROUP_INFO: crate::GroupInfo = crate::GroupInfo {
    ...
    fields: INVERTER_THREE_PHASE_FLOAT_FIELDS,
};
impl crate::GroupMeta for InverterThreePhaseFloat {
    fn group_info() -> &'static crate::GroupInfo {
        &INVERTER_THREE_PHASE_FLOAT_GROUP_INFO
    }
}
