...
impl Model101 {
    ...
    pub const APHB: crate::PointDef<Self, Option<u16>> = crate::PointDef::new(2, 1, false);
    pub const APHC: crate::PointDef<Self, Option<u16>> = crate::PointDef::new(3, 1, false);
    ...
    pub const PHVPHB: crate::PointDef<Self, Option<u16>> = crate::PointDef::new(9, 1, false);
    pub const PHVPHC: crate::PointDef<Self, Option<u16>> = crate::PointDef::new(10, 1, false);
