...
static INVERTER_SINGLE_PHASE_FIELDS: &[crate::FieldInfo] = &[
    crate::FieldInfo {
        name: "a",
        label: "Amps",
...
static INVERTER_SINGLE_PHASE_GROUP_INFO: crate::GroupInfo = crate::GroupInfo {
    name: "inverter_single_phase",
    label: "Inverter (Single Phase)",
    description: "Include this model for single phase inverter monitoring",
    fields: INVERTER_SINGLE_PHASE_FIELDS,
};
impl crate::GroupMeta for InverterSinglePhase {
    fn group_info() -> &'static crate::GroupInfo {
        &INVERTER_SINGLE_PHASE_GROUP_INFO
    }
}
...
impl crate::Model for InverterSinglePhase {
    ...
    const DESCRIPTION: &'static str = "Include this model for single phase inverter monitoring";
