...
static HFRT_FIELDS: &[crate::FieldInfo] = &[
    crate::FieldInfo {
        name: "act_crv",
        label: "ActCrv",
...
static HFRT_GROUP_INFO: crate::GroupInfo = crate::GroupInfo {
    name: "hfrt",
    label: "HFRT",
    description: "High Frequency Ride-through",
    fields: HFRT_FIELDS,
};
impl crate::GroupMeta for Hfrt {
    fn group_info() -> &'static crate::GroupInfo {
        &HFRT_GROUP_INFO
    }
}
impl crate::Group for Hfrt {
    const LEN: u16 = 10;
}
impl Hfrt {
...
bitflags::bitflags! {
    #[doc = " ModEna"] #[doc = " "] #[doc =
    " HFRT control mode. Enable active curve.  Bitfield value."] #[derive(Copy, Clone,
...
static CURVE_FIELDS: &[crate::FieldInfo] = &[
    ...
    crate::FieldInfo {
        name: "tms1",
        label: "Tms1",
        description: "Point 1 must disconnect duration.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "hz1",
        label: "Hz1",
        description: "Point 1 must disconnect frequency.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms2",
        label: "Tms2",
        description: "Point 2 must disconnect duration.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "hz2",
        label: "Hz2",
        description: "Point 2 must disconnect frequency.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms3",
        label: "Tms3",
        description: "Point 3 must disconnect duration.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "hz3",
        label: "Hz3",
        description: "Point 3 must disconnect frequency.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms4",
        label: "Tms4",
        description: "Point 4 must disconnect duration.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "hz4",
        label: "Hz4",
        description: "Point 4 must disconnect frequency.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms5",
        label: "Tms5",
        description: "Point 5 must disconnect duration.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "hz5",
        label: "Hz5",
        description: "Point 5 must disconnect frequency.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms6",
        label: "Tms6",
        description: "Point 6 must disconnect duration.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "hz6",
        label: "Hz6",
        description: "Point 6 must disconnect frequency.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms7",
        label: "Tms7",
        description: "Point 7 must disconnect duration.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "hz7",
        label: "Hz7",
        description: "Point 7 must disconnect frequency.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms8",
        label: "Tms8",
        description: "Point 8 must disconnect duration.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "hz8",
        label: "Hz8",
        description: "Point 8 must disconnect frequency.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms9",
        label: "Tms9",
        description: "Point 9 must disconnect duration.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "hz9",
        label: "Hz9",
        description: "Point 9 must disconnect frequency.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms10",
        label: "Tms10",
        description: "Point 10 must disconnect duration.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "hz10",
        label: "Hz10",
        description: "Point 10 must disconnect frequency.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms11",
        label: "Tms11",
        description: "Point 11 must disconnect duration.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "hz11",
        label: "Hz11",
        description: "Point 11 must disconnect frequency.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms12",
        label: "Tms12",
        description: "Point 12 must disconnect duration.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "hz12",
        label: "Hz12",
        description: "Point 12 must disconnect frequency.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms13",
        label: "Tms13",
        description: "Point 13 must disconnect duration.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "hz13",
        label: "Hz13",
        description: "Point 13 must disconnect frequency.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms14",
        label: "Tms14",
        description: "Point 14 must disconnect duration.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "hz14",
        label: "Hz14",
        description: "Point 14 must disconnect frequency.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms15",
        label: "Tms15",
        description: "Point 15 must disconnect duration.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "hz15",
        label: "Hz15",
        description: "Point 15 must disconnect frequency.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms16",
        label: "Tms16",
        description: "Point 16 must disconnect duration.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "hz16",
        label: "Hz16",
        description: "Point 16 must disconnect frequency.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms17",
        label: "Tms17",
        description: "Point 17 must disconnect duration.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "hz17",
        label: "Hz17",
        description: "Point 17 must disconnect frequency.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms18",
        label: "Tms18",
        description: "Point 18 must disconnect duration.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "hz18",
        label: "Hz18",
        description: "Point 18 must disconnect frequency.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms19",
        label: "Tms19",
        description: "Point 19 must disconnect duration.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "hz19",
        label: "Hz19",
        description: "Point 19 must disconnect frequency.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms20",
        label: "Tms20",
        description: "Point 20 must disconnect duration.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "hz20",
        label: "Hz20",
        description: "Point 20 must disconnect frequency.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "crv_nam",
...
impl crate::Model for Hfrt {
    ...
    const DESCRIPTION: &'static str = "High Frequency Ride-through";
