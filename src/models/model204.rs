...
static AC_METER_ABC_FIELDS: &[crate::FieldInfo] = &[
    crate::FieldInfo {
        name: "a",
        label: "Amps",
...
static AC_METER_ABC_GROUP_INFO: crate::GroupInfo = crate::GroupInfo {
    name: "ac_meter_abc",
    label: "delta-connect three phase (abc) meter",
    description: "",
    fields: AC_METER_ABC_FIELDS,
};
impl crate::GroupMeta for AcMeterAbc {
    fn group_info() -> &'static crate::GroupInfo {
        &AC_METER_ABC_GROUP_INFO
    }
}
