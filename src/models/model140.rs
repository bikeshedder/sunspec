...
static HVRTX_FIELDS: &[crate::FieldInfo] = &[
    crate::FieldInfo {
        name: "act_crv",
        label: "ActCrv",
...
static HVRTX_GROUP_INFO: crate::GroupInfo = crate::GroupInfo {
    name: "hvrtx",
    label: "HVRTX",
    description: "HVRT extended curve",
    fields: HVRTX_FIELDS,
};
impl crate::GroupMeta for Hvrtx {
...
impl crate::Model for Hvrtx {
    ...
    const DESCRIPTION: &'static str = "HVRT extended curve";
