...
static DER_TRIP_HF_FIELDS: &[crate::FieldInfo] = &[
    crate::FieldInfo {
        name: "ena",
        label: "DER Trip HF Module Enable",
        description: "DER high frequency trip control enable.",
...
static DER_TRIP_HF_GROUP_INFO: crate::GroupInfo = crate::GroupInfo {
    name: "DERTripHF",
    label: "DER Trip HF",
    description: "DER high frequency trip model.",
    fields: DER_TRIP_HF_FIELDS,
};
impl crate::GroupMeta for DerTripHf {
    fn group_info() -> &'static crate::GroupInfo {
        &DER_TRIP_HF_GROUP_INFO
    }
}
...
impl crate::Model for DerTripHf {
    ...
    const DESCRIPTION: &'static str = "DER high frequency trip model.";
