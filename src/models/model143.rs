//! LFRTX
/// Type alias for [`Lfrtx`].
pub type Model143 = Lfrtx;
/// LFRTX
///
/// LFRT extended curve
///
...
static LFRTX_FIELDS: &[crate::FieldInfo] = &[
    crate::FieldInfo {
        name: "act_crv",
        label: "ActCrv",
...
static LFRTX_GROUP_INFO: crate::GroupInfo = crate::GroupInfo {
    name: "lfrtx",
    label: "LFRTX",
    description: "LFRT extended curve",
    fields: LFRTX_FIELDS,
};
impl crate::GroupMeta for Lfrtx {
...
static CURVE_FIELDS: &[crate::FieldInfo] = &[
    ...
    crate::FieldInfo {
        name: "hz10",
        label: "Hz10",
        description: "Point 10 frequency.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms11",
    ...
    crate::FieldInfo {
        name: "hz11",
        label: "Hz11",
        description: "Point 11 frequency.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms12",
    ...
    crate::FieldInfo {
        name: "hz12",
        label: "Hz12",
        description: "Point 12 frequency.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms13",
    ...
    crate::FieldInfo {
        name: "hz13",
        label: "Hz13",
        description: "Point 13 frequency.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms14",
    ...
    crate::FieldInfo {
        name: "hz14",
        label: "Hz14",
        description: "Point 14 frequency.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms15",
    ...
    crate::FieldInfo {
        name: "hz15",
        label: "Hz15",
        description: "Point 15 frequency.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms16",
    ...
    crate::FieldInfo {
        name: "hz16",
        label: "Hz16",
        description: "Point 16 frequency.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms17",
    ...
    crate::FieldInfo {
        name: "hz17",
        label: "Hz17",
        description: "Point 17 frequency.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms18",
    ...
    crate::FieldInfo {
        name: "hz18",
        label: "Hz18",
        description: "Point 18 frequency.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms19",
    ...
    crate::FieldInfo {
        name: "hz19",
        label: "Hz19",
        description: "Point 19 frequency.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "tms20",
    ...
    crate::FieldInfo {
        name: "hz20",
        label: "Hz20",
        description: "Point 20 frequency.",
        kind: crate::FieldKind::Point,
    },
    crate::FieldInfo {
        name: "crv_nam",
...
impl crate::Model for Lfrtx {
    ...
    const DESCRIPTION: &'static str = "LFRT extended curve";
