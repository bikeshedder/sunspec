...
impl Model201 {
    ...
    pub const APH_B: crate::PointDef<Self, Option<i16>> = crate::PointDef::new(2, 1, false);
    pub const APH_C: crate::PointDef<Self, Option<i16>> = crate::PointDef::new(3, 1, false);
    ...
    pub const PP_VPH_AB: crate::PointDef<Self, Option<i16>> = crate::PointDef::new(10, 1, false);
    pub const PP_VPH_BC: crate::PointDef<Self, Option<i16>> = crate::PointDef::new(11, 1, false);
    pub const PP_VPH_CA: crate::PointDef<Self, Option<i16>> = crate::PointDef::new(12, 1, false);
