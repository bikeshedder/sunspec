...
pub struct Model201 {
    ...
    ///
    /// Phase B Current
    pub aph_b: Option<i16>,
    /// Amps PhaseC
    ///
    /// Phase C Current
    pub aph_c: Option<i16>,
    ...
    ///
    /// Phase Voltage BC
    pub pp_vph_bc: Option<i16>,
    /// Phase Voltage CA
    ///
    /// Phase Voltage CA
    pub pp_vph_ca: Option<i16>,
...
impl Model201 {
    ...
    pub const APH_B: crate::Point<Self, Option<i16>> = crate::Point::new(2, 1, false);
    pub const APH_C: crate::Point<Self, Option<i16>> = crate::Point::new(3, 1, false);
    ...
    pub const PH_VPH_A: crate::Point<Self, Option<i16>> = crate::Point::new(6, 1, false);
    pub const PH_VPH_B: crate::Point<Self, Option<i16>> = crate::Point::new(7, 1, false);
    pub const PH_VPH_C: crate::Point<Self, Option<i16>> = crate::Point::new(8, 1, false);
    pub const PPV: crate::Point<Self, Option<i16>> = crate::Point::new(9, 1, false);
    pub const PP_VPH_AB: crate::Point<Self, Option<i16>> = crate::Point::new(10, 1, false);
    pub const PP_VPH_BC: crate::Point<Self, Option<i16>> = crate::Point::new(11, 1, false);
    pub const PP_VPH_CA: crate::Point<Self, Option<i16>> = crate::Point::new(12, 1, false);
