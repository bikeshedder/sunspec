...
impl Model201 {
    ...
    pub const APHB: crate::PointDef<Self, Option<i16>> = crate::PointDef::new(2, 1, false);
    pub const APHC: crate::PointDef<Self, Option<i16>> = crate::PointDef::new(3, 1, false);
    pub const A_SF: crate::PointDef<Self, i16> = crate::PointDef::new(4, 1, false);
    pub const PHV: crate::PointDef<Self, Option<i16>> = crate::PointDef::new(5, 1, false);
    pub const PHVPHA: crate::PointDef<Self, Option<i16>> = crate::PointDef::new(6, 1, false);
    pub const PHVPHB: crate::PointDef<Self, Option<i16>> = crate::PointDef::new(7, 1, false);
    pub const PHVPHC: crate::PointDef<Self, Option<i16>> = crate::PointDef::new(8, 1, false);
    pub const PPV: crate::PointDef<Self, Option<i16>> = crate::PointDef::new(9, 1, false);
    pub const PPVPHAB: crate::PointDef<Self, Option<i16>> = crate::PointDef::new(10, 1, false);
    pub const PPVPHBC: crate::PointDef<Self, Option<i16>> = crate::PointDef::new(11, 1, false);
    pub const PPVPHCA: crate::PointDef<Self, Option<i16>> = crate::PointDef::new(12, 1, false);
    ...
    pub const WPHA: crate::PointDef<Self, Option<i16>> = crate::PointDef::new(17, 1, false);
    pub const WPHB: crate::PointDef<Self, Option<i16>> = crate::PointDef::new(18, 1, false);
    pub const WPHC: crate::PointDef<Self, Option<i16>> = crate::PointDef::new(19, 1, false);
    ...
    pub const VAPHA: crate::PointDef<Self, Option<i16>> = crate::PointDef::new(22, 1, false);
    pub const VAPHB: crate::PointDef<Self, Option<i16>> = crate::PointDef::new(23, 1, false);
    pub const VAPHC: crate::PointDef<Self, Option<i16>> = crate::PointDef::new(24, 1, false);
    ...
    pub const VARPHA: crate::PointDef<Self, Option<i16>> = crate::PointDef::new(27, 1, false);
    pub const VARPHB: crate::PointDef<Self, Option<i16>> = crate::PointDef::new(28, 1, false);
    pub const VARPHC: crate::PointDef<Self, Option<i16>> = crate::PointDef::new(29, 1, false);
    ...
    pub const PFPHA: crate::PointDef<Self, Option<i16>> = crate::PointDef::new(32, 1, false);
    pub const PFPHB: crate::PointDef<Self, Option<i16>> = crate::PointDef::new(33, 1, false);
    pub const PFPHC: crate::PointDef<Self, Option<i16>> = crate::PointDef::new(34, 1, false);
    ...
    pub const TOTWHEXPPHA: crate::PointDef<Self, Option<u32>> = crate::PointDef::new(38, 2, false);
    pub const TOTWHEXPPHB: crate::PointDef<Self, Option<u32>> = crate::PointDef::new(40, 2, false);
    pub const TOTWHEXPPHC: crate::PointDef<Self, Option<u32>> = crate::PointDef::new(42, 2, false);
    pub const TOTWHIMP: crate::PointDef<Self, u32> = crate::PointDef::new(44, 2, false);
    pub const TOTWHIMPPHA: crate::PointDef<Self, Option<u32>> = crate::PointDef::new(46, 2, false);
    pub const TOTWHIMPPHB: crate::PointDef<Self, Option<u32>> = crate::PointDef::new(48, 2, false);
    pub const TOTWHIMPPHC: crate::PointDef<Self, Option<u32>> = crate::PointDef::new(50, 2, false);
    pub const TOTWH_SF: crate::PointDef<Self, i16> = crate::PointDef::new(52, 1, false);
    pub const TOTVAHEXP: crate::PointDef<Self, Option<u32>> = crate::PointDef::new(53, 2, false);
    pub const TOTVAHEXPPHA: crate::PointDef<Self, Option<u32>> = crate::PointDef::new(55, 2, false);
    pub const TOTVAHEXPPHB: crate::PointDef<Self, Option<u32>> = crate::PointDef::new(57, 2, false);
    pub const TOTVAHEXPPHC: crate::PointDef<Self, Option<u32>> = crate::PointDef::new(59, 2, false);
    pub const TOTVAHIMP: crate::PointDef<Self, Option<u32>> = crate::PointDef::new(61, 2, false);
    pub const TOTVAHIMPPHA: crate::PointDef<Self, Option<u32>> = crate::PointDef::new(63, 2, false);
    pub const TOTVAHIMPPHB: crate::PointDef<Self, Option<u32>> = crate::PointDef::new(65, 2, false);
    pub const TOTVAHIMPPHC: crate::PointDef<Self, Option<u32>> = crate::PointDef::new(67, 2, false);
    pub const TOTVAH_SF: crate::PointDef<Self, Option<i16>> = crate::PointDef::new(69, 1, false);
    pub const TOTVARHIMPQ1: crate::PointDef<Self, Option<u32>> = crate::PointDef::new(70, 2, false);
    pub const TOTVARHIMPQ1PHA: crate::PointDef<Self, Option<u32>> =
        crate::PointDef::new(72, 2, false);
    pub const TOTVARHIMPQ1PHB: crate::PointDef<Self, Option<u32>> =
        crate::PointDef::new(74, 2, false);
    pub const TOTVARHIMPQ1PHC: crate::PointDef<Self, Option<u32>> =
        crate::PointDef::new(76, 2, false);
    pub const TOTVARHIMPQ2: crate::PointDef<Self, Option<u32>> = crate::PointDef::new(78, 2, false);
    pub const TOTVARHIMPQ2PHA: crate::PointDef<Self, Option<u32>> =
        crate::PointDef::new(80, 2, false);
    pub const TOTVARHIMPQ2PHB: crate::PointDef<Self, Option<u32>> =
        crate::PointDef::new(82, 2, false);
    pub const TOTVARHIMPQ2PHC: crate::PointDef<Self, Option<u32>> =
        crate::PointDef::new(84, 2, false);
    pub const TOTVARHEXPQ3: crate::PointDef<Self, Option<u32>> = crate::PointDef::new(86, 2, false);
    pub const TOTVARHEXPQ3PHA: crate::PointDef<Self, Option<u32>> =
        crate::PointDef::new(88, 2, false);
    pub const TOTVARHEXPQ3PHB: crate::PointDef<Self, Option<u32>> =
        crate::PointDef::new(90, 2, false);
    pub const TOTVARHEXPQ3PHC: crate::PointDef<Self, Option<u32>> =
        crate::PointDef::new(92, 2, false);
    pub const TOTVARHEXPQ4: crate::PointDef<Self, Option<u32>> = crate::PointDef::new(94, 2, false);
    pub const TOTVARHEXPQ4PHA: crate::PointDef<Self, Option<u32>> =
        crate::PointDef::new(96, 2, false);
    pub const TOTVARHEXPQ4PHB: crate::PointDef<Self, Option<u32>> =
        crate::PointDef::new(98, 2, false);
    pub const TOTVARHEXPQ4PHC: crate::PointDef<Self, Option<u32>> =
        crate::PointDef::new(100, 2, false);
    pub const TOTVARH_SF: crate::PointDef<Self, Option<i16>> = crate::PointDef::new(102, 1, false);
